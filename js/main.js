...
const API_KEY = "AIzaSyCnJoKkHlLzrfTT3y_7X53OdbZdOaBVAO0";
...
const chatHistory = [
  {
    ...
    parts: [{
      ...
      - En la suite Luna de Miel se hospedó John F. Kennedy Junior (Hijo del presidente John F. Kennedy). Cuando te pregunten por personajes famososo mencionalo a el, y menciona algunas otras personalidades que hay en Google sobre Hotel Marina Copan.
      `
    }]
  },
  {
    role: "model",
    parts: [{
      text: "¡Hola! 👋 Soy el asistente virtual del Hotel Marina Copán. ¿En qué puedo ayudarte hoy?"
    }]
  }
];
...
messageInput.addEventListener("keydown", (e) => {
    ...
    if(e.key === "Enter" && userMessage && !e.shiftKey && window.innerWidth > 520){
